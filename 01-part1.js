...
// Input: template literal of strings
// Output: Int

const sampleCalibrationDoc = `1abc2
pqr3stu8vwx
a1b2c3d4e5f
treb7uchet`
const calibrationDoc = `kjrqmzv9mmtxhgvsevenhvq7
...
function recoverCalibrationValues(calibrationContent) {
    let numsToSum = []
    let sampleCalibrationDoc = calibrationContent.split(/\s+/)
    for (let word of sampleCalibrationDoc) {
...
const recoveredSampleCalibrationDoc = recoverCalibrationValues(sampleCalibrationDoc)
// Expected output: 142 (sum of 12, 38, 15, and 77)
console.log(recoveredSampleCalibrationDoc)
